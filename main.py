...
# GENAI_API_KEY = st.secrets["GEMINI"]["API_KEY"]  # Fetch from Streamlit Secrets

# # ✅ Check if API key exists before configuring Gemini API
# if not GENAI_API_KEY:
#     st.error("❌ API Key is missing! Add it to Streamlit Secrets.")
#     st.stop()  # Stop execution if API key is missing

# # ✅ Configure Gemini API (Only if API key is found)
